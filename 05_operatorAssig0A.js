...
function greaterNumber(num1,num2){
     var result=num1 > num2 ? `Num 1 is greater value which is: ${num1}` : `Num 2 is greater value which is: ${num2}`;
     console.log(result);
}
greaterNumber(10,-10);
...
function isEvenOrOddNum(num){
      var result1=((num % 2) == 0) ? `The value ${num} is even:true` : `The value ${num} is even:false`;
      return result1;
    }
